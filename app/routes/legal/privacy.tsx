  ...
  return (
    <>
      ...
      <section className="prose text-gray-500 py-12 max-w-7xl mx-auto px-4 sm:px-6">
        <h1>Privacy Policy for Fungi</h1>

        <p>
          At Fungi, accessible from https://fungirealti.me, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Fungi and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Fungi. This policy is not applicable to any
        ...
        <p>
          Like any other website, Fungi uses 'cookies'. These cookies are used
        ...
        <p>
          ...
          advertising partners of Fungi.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Fungi, which are sent directly
        ...
        <p>
          Note that Fungi has no access to or control over these cookies that
        ...
        <p>
          Fungi's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          Fungi does not knowingly collect any Personal Identifiable Information
