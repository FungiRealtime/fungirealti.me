  ...
  return (
    <>
      ...
      <section className="prose text-gray-500 py-12 max-w-7xl mx-auto px-4 sm:px-6">
        <h1>Privacy Policy for Fungi Realtime</h1>

        <p>
          At Fungi Realtime, accessible from https://fungirealti.me, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Fungi Realtime and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Fungi Realtime. This policy is not applicable
        ...
        <p>
          Fungi Realtime follows a standard procedure of using log files. These
        ...
        <p>
          Like any other website, Fungi Realtime uses 'cookies'. These cookies
        ...
        <p>
          ...
          advertising partners of Fungi Realtime.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Fungi Realtime, which are sent
        ...
        <p>
          Note that Fungi Realtime has no access to or control over these
        ...
        <p>
          Fungi Realtime's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          Fungi Realtime does not knowingly collect any Personal Identifiable
